...
export const IntroSection = () => {
  return (
    <section id="introduction" className="relative pb-8 lg:pb-20 border-0 dark:bg-zinc-900 dark:border-b dark:border-orange-500">
      <div className="w-full mx-auto px-4">
        ...
        <div id="check-us" className="flex flex-col md:flex-row items-center mt-8">
          <div className="w-full md:w-5/12 px-4 mx-auto sm:my-16">
            ...
            <h3 className="text-3xl mb-2 font-semibold leading-normal dark:text-zinc-400">
              Find us
            </h3>
            <p className="text-lg font-extralight leading-relaxed my-4 text-gray-600 dark:text-zinc-500">
            ...
            <p className="text-lg font-extralight leading-relaxed mt-0 mb-4 text-gray-600 dark:text-zinc-500">
            ...
            <Link
              href="/store"
              className="font-bold text-gray-800 dark:text-zinc-400 mt-8"
            >
          ...
          <div className="w-full md:w-4/12 px-4 mx-auto lg:mt-0 mt-16">
            <div className="relative flex flex-col min-w-0 wrap-break-word w-full mb-6 shadow-lg rounded-lg bg-pink-600 dark:bg-zinc-700">
              <Image
                alt="..."
              ...
              <blockquote className="relative p-8 mb-4">
                ...
                >
                  <polygon
                    ...
                    className="text-pink-600 dark:text-zinc-700 fill-current"
                  ></polygon>
                </svg>
                <h4 className="text-xl font-bold text-white dark:text-gray-300">
                  Top Notch Services
                </h4>
                <p className="text-md font-light mt-2 text-white dark:text-gray-400">
